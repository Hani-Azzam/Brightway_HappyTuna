...
Kept as a plain local dataclass on purpose: it is the seam where a shared event
schema could later slot in without touching the routing rules. For now it
